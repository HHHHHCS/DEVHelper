...
namespace communication
{
    ...
    class LinkConfiguration : public QObject
    {
        ...
        public:
            ...
            Q_PROPERTY(LinkType linkType READ getLinkType CONSTANT)
        ...
        public:
            ...
            void setLink(std::shared_ptr<Link> link) { m_p_link = link; Q_EMIT linkChanged(); }
            void setName(const QString &name) { m_name = name; Q_EMIT nameChanged(name); }
            ...
            static LinkConfiguration* createSettings(LinkType type, const QString& name);
            static LinkConfiguration* duplicateSettings(LinkConfiguration &src);

        protected:
            std::weak_ptr<Link> m_p_link;
